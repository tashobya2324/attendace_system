...
| Document | Covers |
|---|---|
| [01-Project-Report.md](01-Project-Report.md) | Problem statement, objectives, AI methodology, architecture, conclusion — the assignment write-up |
| [02-User-Manual.md](02-User-Manual.md) | Step-by-step guide for the HR Officer and CAO roles |
| [03-Database-Dictionary.md](03-Database-Dictionary.md) | Full schema reference, table by table |
| [04-API-Reference.md](04-API-Reference.md) | Every `api/*.php` endpoint and the core AI functions |
